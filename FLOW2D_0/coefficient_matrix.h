...
template<unsigned N1, unsigned N2, unsigned N3>
CoeffMatrix3D<N1, N2, N3>::CoeffMatrix3D() {
...
template<unsigned N1, unsigned N2, unsigned N3>
void CoeffMatrix3D<N1, N2, N3>::setNumberOfElements(unsigned const numElements) {
...
template<unsigned N1, unsigned N2, unsigned N3>
void CoeffMatrix3D<N1, N2, N3>::setZero() {
...
template<unsigned N1, unsigned N2, unsigned N3>
inline double & CoeffMatrix3D<N1, N2, N3>::setCoeff(unsigned const elementIndex, unsigned const n1, unsigned const n2, unsigned const n3) {

	return data[n3 + N3 * (n2 + N2 * (n1 + N1 * elementIndex))];

};
template<unsigned N1, unsigned N2, unsigned N3>
inline double CoeffMatrix3D<N1, N2, N3>::operator()(unsigned const elementIndex, unsigned const n1, unsigned const n2, unsigned const n3) const {
...
template<unsigned N1, unsigned N2, unsigned N3>
void CoeffMatrix3D<N1, N2, N3>::operator=(CoeffMatrix3D const & m) {
